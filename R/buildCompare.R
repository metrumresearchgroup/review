...
#'
#' @keywords internal
buildCompare <- function(.dfpaths, .side_by_side, .headings, .open_all = TRUE) {
...
")
    ...
    rmd_body <-
      paste(
        ...
        paste0("<div id=\"collapsibleContent", i, "\" style=\"border: 1px solid #ccc; padding: 10px; display: ", ifelse(.open_all, "block", "none"), ";\">"),
        graphics.i,
        "</div>",
        "<hr>",
        sep = "\n"
