...
A rendered diff in your Viewer pane, where lines added, removed, or changed between revision 2 and your local version (or specified .current_revision) are highlighted.
